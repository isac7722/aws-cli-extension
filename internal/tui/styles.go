...
var (
	...
	// CardStyle is a rounded-border box for displaying profile summaries.
	CardStyle = Renderer.NewStyle().
			Border(lipgloss.RoundedBorder()).
			BorderForeground(lipgloss.Color("8")).
			Padding(0, 1)

	// CardLabel is the left-aligned label inside a card row.
	CardLabel = Renderer.NewStyle().Width(10).Foreground(lipgloss.Color("8"))
)
